      ...
      <Layout>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="m-1">
            ...
            <Accordion title={'「アップロードしてリンクを共有」とは、どのような機能ですか?'}>
              <p>この機能は、アプリ内で作成した問題集の「コピー」をインターネット上にアップロードし、その問題集をダウンロードするためのリンクを発行する機能です。このリンクを他の端末から押下することで、問題集をダウンロードして使用することができます。</p>
            </Accordion>

            <Accordion title={'「テキスト形式に変換して共有」とは、どのような機能ですか?'}>
              <p>この機能は、アプリ内で作成した問題集を、コンマ区切りのCSVテキストに変換する機能です。問題集の画像情報が失われてしまう、という欠点はありますが、エクセルやスプレッドシートを用いて効率的に問題集を編集することが可能になります。</p>
            </Accordion>
