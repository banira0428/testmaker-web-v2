    ...
    <div>
      ...
      <Layout>
        <div className="mx-auto max-w-5xl p-3">
          ...
          {/* 右下のボタンを強調したスクショ */}
          <img src="/img/Inkedshare_tests2-1_LI.jpg"/>
          <img src="/img/Inkedshare_tests2-2_LI.jpg"/>
          <img src="/img/Inkedshare_tests2-3_LI.jpg"/>
          ...
          <img src="/img/Inkedshare_tests3-1_LI.jpg"/>
          <img src="/img/share_tests3-2.jpg"/>
